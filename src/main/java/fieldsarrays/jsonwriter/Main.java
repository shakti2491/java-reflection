package fieldsarrays.jsonwriter;

import fieldsarrays.data.Address;
import fieldsarrays.data.Company;
import fieldsarrays.data.Person;
...
public class Main {
    ...
    public static void main(String[] args) throws IllegalAccessException {
        Address address = new Address("7650 McCallum Blvd",(short) 2006);
        Company company = new Company("Udemy","San Fransico",new Address("7650 Arthur Road",(short) 11));
        Person person = new Person("John",true,29,150000,address,company);
